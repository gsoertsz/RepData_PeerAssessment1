...
imputed_table <- xtable(head(imputed_activity[(which(is.na(imputed_activity$steps)) | (imputed_activity$steps != 0)), c("date", "interval", "steps", "imputed_steps")], 50), );
...
xta <- xtable(head(calendarizedAdjustedActivity), )
print(xta, "html")
````  
